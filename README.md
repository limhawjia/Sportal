...
# **_<span style="text-decoration:underline;">Sportal</span>_**
...
2. Providing an integrated service to communicate, coordinate and manage all details regarding the game.
...
2. As a sport player, I want to be able to quickly find a joinable match that conforms to my constraints, such as time and location requirements.
...
4. As a sport player/match organizer, I want to be able to easily communicate with players in the same game as me to settle details or simply have a chat.
